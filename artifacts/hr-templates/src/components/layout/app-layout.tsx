  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="hidden md:flex w-64 bg-sidebar border-r border-sidebar-border text-sidebar-foreground flex-col shrink-0">
        <div className="p-6">
          <img src="https://res.cloudinary.com/dsmqkbssm/image/upload/v1783954486/Duollance_gradient_300x_vzodoc.png" alt="Duollance" className="h-8 object-contain" />
        </div>
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-sidebar text-sidebar-foreground flex flex-col shadow-xl">
            <div className="flex items-center justify-between px-6 py-5 border-b border-sidebar-border">
              <img src="https://res.cloudinary.com/dsmqkbssm/image/upload/v1783954486/Duollance_gradient_300x_vzodoc.png" alt="Duollance" className="h-7 object-contain" />
